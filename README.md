...
flashrom 1.4.0dev build for windows x64 buspirate_spi ch347_spi ch341a_spi ft2232_spi

**WARNING**: bus pirate + flashrom in a VM can cause problems.... use ALWAYS a native OS
...
https://github.com/therealdreg/flashrom_build_windows_x64/releases/download/flashrom.1.4.0dev.Dreg/flashrom_build_windows_x64.zip
...
If the above command doesn't work (freezes), reconnect the USB Bus Pirate, and try using -VVV and a slow SPI instead:
```
flashrom.exe --progress -VVV -c "W25Q64JV-.Q" -p buspirate_spi:dev=COM6,spispeed=1M -r flash_contenido.img > log.txt
```
...
Command line (7 args): flashrom -VV -c W25Q64JV-.Q -p buspirate_spi:dev=COM6 -r flash_content.img
Initializing buspirate_spi programmer
Baud rate is 115200.
Detected Bus Pirate hardware 3.5 ("v3.5")
