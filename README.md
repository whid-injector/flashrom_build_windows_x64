...
Download [https://github.com/therealdreg/flashrom_build_windows_x64/blob/main/flashrom.exe](https://github.com/therealdreg/flashrom_build_windows_x64/raw/main/flashrom.exe)

Example of use:
```
dreg@rootkit.es# flashrom -VV -c "W25Q64JV-.Q" -p buspirate_spi:dev=COM6 -r flash_content.img
